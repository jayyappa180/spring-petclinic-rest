...
//    }
    ...
    public void shouldFindAllPetsByOwnerId(){
        Collection<Pet> pets = this.clinicService.findAllPetsByOwnerId(10);
        Pet pet1 = EntityUtils.getById(pets, Pet.class, 12);
        assertThat(pet1.getName()).isEqualTo("Lucky");
        Pet pet2 = EntityUtils.getById(pets, Pet.class, 13);
        assertThat(pet2.getName()).isEqualTo("Sly");
    }

    @Test
    public void shouldFindAllPetsByVet(){
        Collection<Pet> pets = this.clinicService.findAllPetsByVet(3);
        Pet pet1 = EntityUtils.getById(pets, Pet.class, 8);
        assertThat(pet1.getName()).isEqualTo("Max");
        Pet pet2 = EntityUtils.getById(pets, Pet.class, 7);
        assertThat(pet2.getName()).isEqualTo("Samantha");
    }
}
