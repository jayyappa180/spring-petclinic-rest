...
public class PetRestControllerTests {
    ...
    @Test
    public void testFindAllPetsByOwnerIdSuccess() throws Exception {
        given(this.clinicService.findAllPetsByOwnerId(1)).willReturn(pets);
    ...
    @Test
    public void testFindAllPetsByOwnerIdFailure() throws Exception {
        given(this.clinicService.findAllPetsByOwnerId(1)).willReturn(null);
        this.mockMvc.perform(get("/api/pets/owner/1")
            .accept(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(status().isBadRequest());
    }
    ...
    @Test
    public void testFindAllPetsByVetSuccess() throws Exception {
        given(this.clinicService.findAllPetsByVet(1)).willReturn(pets);
        this.mockMvc.perform(get("/api/pets/vet/1")
            .accept(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(status().isOk())
            .andExpect(content().contentType("application/json;charset=UTF-8"))
            .andExpect(jsonPath("$.[0].id").value(3))
    ...
    @Test
    public void testFindAllPetsByVetFailure() throws Exception {
        given(this.clinicService.findAllPetsByVet(1)).willReturn(null);
        this.mockMvc.perform(get("/api/pets/vet/1")
            .accept(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(status().isBadRequest());
    }
