...
public class PetRestController {
    ...
    public ResponseEntity<Collection<Pet>> getAllPetsByOwnerid(@PathVariable("ownerId") int ownerId) {
        try {
    ...
    @Transactional
    public ResponseEntity<Collection<Pet>> getAllPetsByVetId(@PathVariable("vetId") int vetId) {
        try {
